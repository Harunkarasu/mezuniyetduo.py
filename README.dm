...
Merhaba,ben Harun KARASU.Ben,Rüzgar Nihat YEŞİLYURT ile Kodland Mezuniyet projesi yaptık.Projemiz bunları içermektedir:
///
///
...
Bazı soruları yapay zeka desteği sayesinde cevaplayabilmektedir.
///
///
///
/// 
